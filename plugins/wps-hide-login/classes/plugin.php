...
class Plugin {
	...
	public function whl_page_input() {
		...
		echo '<p class="description">' . __( 'Protect your website by changing the login ViewSchedule and preventing access to the wp-login.php page and the wp-admin directory to non-connected people.', 'wpserveur-hide-login' ) . '</p>';
	...
	public function whl_redirect_admin_input() {
		...
		echo '<p class="description">' . __( 'Redirect ViewSchedule when someone tries to access the wp-login.php page and the wp-admin directory while not logged in.', 'wpserveur-hide-login' ) . '</p>';
	}
